  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mt-8">
        ...
        <div className="flex gap-3">
          <div className="shrink-0 mt-1">
            <div className="flex h-7 w-7 items-center justify-center" style={{ backgroundColor: "#6B5CA5" }}>
              <span className="text-[10px] font-mono font-bold text-white">J</span>
            </div>
          </div>
          <div className="flex-1 debate-judge px-4 py-3">
            <div className="text-[10px] font-sans font-semibold uppercase tracking-widest mb-2" style={{ color: "#6B5CA5" }}>
              Judge
            </div>
            <div className="text-[13px] font-sans text-ink-700 leading-relaxed whitespace-pre-wrap">
