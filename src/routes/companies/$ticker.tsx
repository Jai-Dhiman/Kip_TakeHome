  ...
  if (!company) {
    return (
      <div className="text-center py-20">
        ...
        <Link to="/" className="text-rust-500 link-underline mt-2 inline-block font-sans text-sm">
          Back to dashboard
        </Link>
      </div>
    );
  ...
  return (
    <div>
      ...
      <div className="mb-6">
        ...
        <span className="text-xs font-sans font-medium text-ink-900">{company.ticker}</span>
      </div>
            ...
            <div className="space-y-0">
              {company.quarters.map((q, i) => (
                <Link
                  ...
                  style={i < company.quarters.length - 1 ? { borderBottom: "1px solid #F0EBE1" } : undefined}
                >
                  <div>
