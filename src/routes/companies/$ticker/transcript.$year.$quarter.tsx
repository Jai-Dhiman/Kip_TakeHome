...
function TranscriptViewer() {
	...
	if (!data) {
		return (
			<div className="text-center py-20">
				<h2 className="text-xl font-serif text-ink-400">
	...
	const preparedClaims = claims.filter((c) => c.session === "prepared_remarks");
		...
		<div className="group">
			<div className="flex items-start gap-3">
				<div className="shrink-0 w-24 text-right">
					...
					<br />
					<span className="text-[10px] font-sans text-ink-300">
						{claim.speaker_role}
					</span>
				</div>
				<div
