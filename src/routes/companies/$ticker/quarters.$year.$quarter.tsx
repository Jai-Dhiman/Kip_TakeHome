		...
		<div className="mt-8 space-y-8">
			...
			<section className="space-y-4">
				<div className="flex items-baseline justify-between">
					<h3 className="text-lg font-serif text-ink-900">All Claims</h3>
				...
				<div className="flex flex-wrap gap-2 pt-2">
					...
					<Badge
						color="#B54A32"
						label="Inaccurate"
						count={statusCounts.inaccurate ?? 0}
					/>
					<Badge
						color="#C48B20"
						label="Misleading"
						count={statusCounts.misleading ?? 0}
					/>
					<Badge
						color="#7A8599"
						label="Unverifiable"
						count={statusCounts.unverifiable ?? 0}
					/>
					<Badge
						color="#A0AEC0"
						label="Not Verified"
						count={statusCounts.not_verified ?? 0}
					/>
				</div>
